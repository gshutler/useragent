# 1.3.0
* Add browser support for AndroidDownloadManager, AudioClip, BeyondPod, Breaker, Castro, Deezer, Downcast, Googlebot, Himalaya, Luminary, NPR One, PodMN, Podcast Republic, Podimo, Podkicker, RadioPublic, Spreaker
