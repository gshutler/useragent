# 1.3.0
* Add browser support for AndroidDownloadManager, AudioClip, Breaker, Castro, Deezer, Downcast, Googlebot, Himalaya, Luminary, NPR One, Podcast Republic, Podkicker, RadioPublic
