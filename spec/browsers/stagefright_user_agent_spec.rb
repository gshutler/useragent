...
describe "UserAgent: AlcatelOneTouch-Alcatel_5044R-SVN/02; stagefright/1.2 (Linux;Android 7.0)" do
  before do
    @useragent = UserAgent.parse("AlcatelOneTouch-Alcatel_5044R-SVN/02; stagefright/1.2 (Linux;Android 7.0)")
  end
...
describe "UserAgent: BLADE L111-stagefright/1.2 (Linux;Android 5.1)" do
  before do
    @useragent = UserAgent.parse("BLADE L111-stagefright/1.2 (Linux;Android 5.1)")
  end
...
describe "UserAgent: Fire OS/5.1.1 stagefright/1.2 (Linux;Android 5.1.1) ,Dalvik/2.1.0 (Linux; U; Android 5.1.1; KFFOWI Build/LMY47O)" do
  before do
    @useragent = UserAgent.parse("Fire OS/5.1.1 stagefright/1.2 (Linux;Android 5.1.1) ,Dalvik/2.1.0 (Linux; U; Android 5.1.1; KFFOWI Build/LMY47O)")
  end
...
describe "UserAgent: Fire OS/6.0 stagefright/1.2 (Linux;Android 7.1.2)" do
  before do
    @useragent = UserAgent.parse("Fire OS/6.0 stagefright/1.2 (Linux;Android 7.1.2)")
  end
...
describe "UserAgent: stagefright/1.2 (Linux;Android 5.0 Huawei HUAWEI GRA-L09 GRA-L09V100R001C150B134)" do
  before do
    @useragent = UserAgent.parse("stagefright/1.2 (Linux;Android 5.0 Huawei HUAWEI GRA-L09 GRA-L09V100R001C150B134)")
  end
...
describe "UserAgent: stagefright/1.2 (Linux;Android 4.0.3) Mozilla/5.0(iPad; U; CPU iPhone OS 3_2 like Mac OS X; en-us) AppleWebKit/531.21.10 (KHTML, like Gecko) Version/4.0.4 Mobile/7B314 Safari/531.21.10" do
  before do
    @useragent = UserAgent.parse("stagefright/1.2 (Linux;Android 4.0.3) Mozilla/5.0(iPad; U; CPU iPhone OS 3_2 like Mac OS X; en-us) AppleWebKit/531.21.10 (KHTML, like Gecko) Version/4.0.4 Mobile/7B314 Safari/531.21.10")
  end
...
describe "UserAgent: LG-E615f/LG-E615f-V10p-SEP-02-2013 Player/NexPlayer 4.0 for Android (stagefright alternative) ,Mozilla/5.0 (Windows NT 6.2; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1667.0 Safari/537.36" do
  before do
    @useragent = UserAgent.parse("LG-E615f/LG-E615f-V10p-SEP-02-2013 Player/NexPlayer 4.0 for Android (stagefright alternative) ,Mozilla/5.0 (Windows NT 6.2; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1667.0 Safari/537.36")
  end
...
describe "UserAgent: LG-D802/Desperate Rom LP UX4 V4 Player/LG Player 1.0 for Android 5.0.2 (stagefright alternative)" do
  before do
    @useragent = UserAgent.parse("LG-D802/Desperate Rom LP UX4 V4 Player/LG Player 1.0 for Android 5.0.2 (stagefright alternative)")
  end
...
describe "UserAgent: LG-H873/V15c Player/LG Player 1.0 for Android 7.0 (stagefright alternative)" do
  before do
    @useragent = UserAgent.parse("LG-H873/V15c Player/LG Player 1.0 for Android 7.0 (stagefright alternative)")
  end
...
describe "UserAgent: LG-H955/V15c Player/LG Player 1.0 for Android 5.1.1 (stagefright alternative) BMID/E67AB269FB" do
  before do
    @useragent = UserAgent.parse("LG-H955/V15c Player/LG Player 1.0 for Android 5.1.1 (stagefright alternative) BMID/E67AB269FB")
  end
