...
describe "UserAgent: Pocket Casts BMID/E678F58F21" do
  before do
    @useragent = UserAgent.parse("Pocket Casts BMID/E678F58F21")
  end
...
describe "UserAgent: PocketCasts/1.0 (Pocket Casts Feed Parser; +http://pocketcasts.com/)" do
  before do
    @useragent = UserAgent.parse("PocketCasts/1.0 (Pocket Casts Feed Parser; +http://pocketcasts.com/)")
  end
...
describe "UserAgent: Shifty Jelly Pocket Casts, Android v4.5.3" do
  before do
    @useragent = UserAgent.parse("Shifty Jelly Pocket Casts, Android v4.5.3")
  end
...
describe "UserAgent: Shifty Jelly Pocket Casts, iOS v4.3" do
  before do
    @useragent = UserAgent.parse("Shifty Jelly Pocket Casts, iOS v4.3")
  end
...
describe "UserAgent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Pocket Casts/1.1 Pocket Casts/1.1" do
  before do
    @useragent = UserAgent.parse("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Pocket Casts/1.1 Pocket Casts/1.1")
  end
